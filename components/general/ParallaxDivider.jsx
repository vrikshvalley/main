...
export default function ParallaxDivider() {
  ...
  return (
    <div ref={ref} style={{ position: 'relative', height: '150px', marginTop: '-50px', marginBottom: '20px', overflow: 'hidden', pointerEvents: 'none', zIndex: 1, transform: 'scaleY(-1)', transformOrigin: 'center center' }}>
       {/* Background Bushes */}
       <motion.div style={{ y: yBack, position: 'absolute', bottom: '-20px', left: 0, width: '100%', opacity: 0.4 }} >
       ...
       <motion.div style={{ y: yFront, position: 'absolute', bottom: '-60px', left: 0, width: '100%' }}>
