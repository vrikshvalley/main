...
export default function WhereNatureMeetsNurturePage() {
  return (
    <div className="green-movement-page">
      ...
      <section className="green-movement-promises">
        <h3>Handpicked, Heartfelt Care</h3>
        <p>
        ...
        <ul>
          <li><b>Expertly Curated Plants:</b> We vet each plant by soil, climate and origin to ensure you receive only the healthiest specimens for your space.</li>
          <li><b>Guides & Tutorials:</b> Every plant arrives with clear care instructions. We share step-by-step guides (on our blog and YouTube channel) and quick tips (on Instagram and Facebook) so you always know how to nurture your greens.</li>
          <li><b>Personalized Support:</b> When you join Vriksh Valley, you become part of our family. We remember your name—and your plant’s name—offering one-on-one help through chat or call whenever you need us.</li>
          <li><b>Sustainable Growth:</b> We use eco-friendly packaging and organic methods, so each plant (and the earth it came from) gets only healthy, natural care.</li>
        </ul>
        <p>
      ...
      <section className="green-movement-companion">
        <h3>Your Nature’s Companion</h3>
        <p>
      ...
      <section className="green-movement-tribe">
        <h3>Growing Together: Join Our Tribe</h3>
        <p>
